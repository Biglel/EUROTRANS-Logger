...
MainWindow::MainWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_menuItemSettings = new wxMenuItem( m_menuFile, wxID_SETUP, wxString( wxT("Paramètres") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuFile->Append( m_menuItemSettings );

	m_menuFile->AppendSeparator();

	wxMenuItem* m_menuItemExit;
	m_menuItemExit = new wxMenuItem( m_menuFile, wxID_EXIT, wxString( wxT("Fermer") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuFile->Append( m_menuItemExit );

	m_menubar1->Append( m_menuFile, wxT("Fichier") );

	wxMenu* m_menuHelp;
	m_menuHelp = new wxMenu();
	wxMenuItem* m_menuItemAbout;
	m_menuItemAbout = new wxMenuItem( m_menuHelp, wxID_ABOUT, wxString( wxT("A Propos") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuHelp->Append( m_menuItemAbout );

	m_menubar1->Append( m_menuHelp, wxT("Aide") );
	...
	sbSizer3 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Livraison") ), wxVERTICAL );
	...
	m_staticTextCargo = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Remorque"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextOrigin = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Origine:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextMass = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Poids:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextIncome = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Facturé:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextCargoDamage = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Dommage:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextDriven = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Distance parcourue:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextFuel = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Carburant consommé"), wxDefaultPosition, wxDefaultSize, 0 );
