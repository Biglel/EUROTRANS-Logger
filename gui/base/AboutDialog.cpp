...
AboutDialog::AboutDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticTextName = new wxStaticText( this, wxID_ANY, wxT("EUROTRANS Logger"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText2 = new wxStaticText( this, wxID_ANY, wxT("Copyright © 2020 EUROTRANS - DAHMANE Bilel & Tomi Lähteenmäki"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText3 = new wxStaticText( this, wxID_ANY, wxT("Site internet:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText3->Wrap( -1 );
	bSizer7->Add( m_staticText3, 0, wxALIGN_CENTER|wxALL, 5 );

	wxHyperlinkCtrl* m_hyperlink1;
	m_hyperlink1 = new wxHyperlinkCtrl( this, wxID_ANY, wxT("https://eurotrans.me"), wxT(""), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
